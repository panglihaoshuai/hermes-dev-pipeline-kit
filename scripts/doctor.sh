...
check_core "plugin wrapper authorization.py (source)" "$KIT_ROOT/plugins/hermes-evidence-runtime/authorization.py"
check_core "plugin wrapper control_store.py (source)" "$KIT_ROOT/plugins/hermes-evidence-runtime/control_store.py"
...
check_core "plugin wrapper integrations/__init__.py (source)" "$KIT_ROOT/plugins/hermes-evidence-runtime/integrations/__init__.py"
    ...
    check_core "plugin wrapper integrations/external_e2e.py (source)" "$KIT_ROOT/plugins/hermes-evidence-runtime/integrations/external_e2e.py"
...
check_core "smoke-plugin-discovery-temp-home.sh" "$KIT_ROOT/scripts/smoke/smoke-plugin-discovery-temp-home.sh"
    ...
    check_core "smoke-plugin-v09-external-classification.sh" "$KIT_ROOT/scripts/smoke/smoke-plugin-v09-external-classification.sh"
    check_core "smoke-plugin-v09-combined-deterministic-regression.sh" "$KIT_ROOT/scripts/smoke/smoke-plugin-v09-combined-deterministic-regression.sh"
    ...
    check_core "smoke-plugin-v10-authorization-lifecycle.sh" "$KIT_ROOT/scripts/smoke/smoke-plugin-v10-authorization-lifecycle.sh"
    check_core "smoke-plugin-v101-authorization-persistence.sh" "$KIT_ROOT/scripts/smoke/smoke-plugin-v101-authorization-persistence.sh"
...
check_core "replay-result.schema.json" "$KIT_ROOT/schema/replay-result.schema.json"
    ...
    check_core "run-authorization.schema.json" "$KIT_ROOT/schema/run-authorization.schema.json"
    check_core "live-mutation-approval.schema.json" "$KIT_ROOT/schema/live-mutation-approval.schema.json"
    check_core "terminal-verdict.schema.json" "$KIT_ROOT/schema/terminal-verdict.schema.json"
...
check_core "docs/authorization-lifecycle.md" "$KIT_ROOT/docs/authorization-lifecycle.md"
