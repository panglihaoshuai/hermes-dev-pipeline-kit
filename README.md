...
## v0.5.1 / v0.5.2 / v0.5.3 / v0.5.4 / v0.5.5 / v0.6 Experimental Plugin Wrapper
...
v0.6 adds live enablement and tool-call smoke evidence, but it still proves only
plugin enablement and tool callability.
...
## v0.5.1 / v0.5.2 / v0.5.3 / v0.5.4 / v0.5.5 / v0.6 Plugin Wrapper Boundary
