...
| 风险项 | 分类 | 是否阻塞 | 处理建议 |
|--------|------|----------|----------|
| | BLOCKER / TASK_RELATED / BASELINE_TECH_DEBT / OPTIONAL_POLISH / BACKLOG | 是/否 | |

## Codex / gstack 审查说明

- Codex plan review: PASS / deferred / skipped (原因：)
- Codex diff review: PASS / deferred / skipped (原因：)
- gstack plan-eng-review: PASS / skipped (原因：)
...
## Verification Exit Code Evidence

| 验证命令 | exit code | 结果 | 是否阻塞 |
|----------|-----------|------|----------|
| | | PASS/FAIL | 是/否 |
